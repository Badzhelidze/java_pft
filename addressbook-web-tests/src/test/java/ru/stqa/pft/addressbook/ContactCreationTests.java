...
public class ContactCreationTests {
    ...
    public void ContactCreationTests() {
        ...
        wd.findElement(By.name("middlename")).sendKeys("badzhelidze");
        wd.findElement(By.name("lastname")).click();
        wd.findElement(By.name("lastname")).clear();
        wd.findElement(By.name("lastname")).sendKeys("badzhelidze");
        ...
        wd.findElement(By.name("company")).sendKeys("123");
        wd.findElement(By.name("address")).click();
        wd.findElement(By.name("address")).clear();
        wd.findElement(By.name("address")).sendKeys("123");
        ...
        wd.findElement(By.name("work")).sendKeys("123");
